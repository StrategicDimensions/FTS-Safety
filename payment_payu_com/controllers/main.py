...
class PayuController(http.Controller):
	...
	sale_order_obj = request.env['sale.order']
        ...
        transactionDetails['store']['soapUsername'] = '203988'
        transactionDetails['store']['soapPassword'] = 'fZxp6LeR'
        transactionDetails['store']['safekey'] = '{8BAAD392-CFAE-46AC-991E-C76B2C767971}'
    ...
    def redirect_payu(self, **post):
        ...
        transactionDetails['basket']['description'] = 'FTS Safety'
	...
	transactionDetails['additionalInformation'] = {}
        ...
        transactionDetails['additionalInformation']['returnUrl'] =  'http://sarissa.ftssafety.co.za/payment/payu_com/dpn'
        transactionDetails['additionalInformation']['cancelUrl'] =  'http://sarissa.ftssafety.co.za/payment/payu_com/cancel'
    ...
    def payuMeaSetTransactionApiCall(self,args):    
	    ...
	    #print e,'Exceptionnnnnnnnnn'
            ...
            return "http://sarissa.ftssafety.co.za/shop/unsuccessful"
